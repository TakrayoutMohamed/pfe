        ...
        <div class="row mx-0" style="min-height:380px;">
            <div class="col-lg-4 col-md-4 col-sm-12 mt-5 ml-0">
                <div class="card-user card radius-top" >
                    <div class="image radius-top position-relative " id="bgback" style="width:100%; height:180px;" >
                        ...
                        ?>
                        @if ($w==1)
                            <img src="{{asset('./assets/DataDoc/IMG/Back_image/'.$users->details[0]->Bg_image)}}" alt="..." style="width:100%; height:180px;">
                        @else
                        ...
                        <div class="author bgblack radius-down">
                            <a>
                                <div class="justify-content-center row">
                                    <div class=" avatar " id="{{$users->Gender=='Female'?'bgfemale':'bgmale'}}">
                                        @if ($w==1)
                                            <img src="{{asset('./assets/DataDoc/IMG/Profile/'.$users->details[0]->Profil_image)}}" alt="profile picture" class="avatar position-relative " style="width:140px; height:140px;" >
                                        @else
                                            <img src="" alt="..." style="width:100%; height:180px;">
                                        @endif
                                    </div>
                                ...
                                @if ($w==1)
                                    <p class="h6">{{$users->details[0]->Position}}</p>
                                @else
                                    <p class="h6">the taecher position in the fpo</p>
                                @endif
                                <h5 class="title" style="color:orangered;">{{$users->FirstName.' '.$users->LastName }}</h5>
                            </a>
                        </div>
                        <div class="description bgblack  text-center radius-top" style="margin:0px -12px 0px -12px;">
                            <i class="h5"> biography </i>
                        </div>
                        <div  class="description p-1 bg-dark  "  style="margin:0px -12px 0px -12px; width:auto; border:black dashed 2px; border-top:0px;">
                            @if ($w==1)
                                <p class="">{{$users->details[0]->Biography}}</p>
                            @else
                    ...
                    <div class="container text-center pt-1 form-control radius-down">
                        ...
                        @if ($w==1)
                            <a href="{{$users->details[0]->Facebook}}" target="_blank" class="btn btn-neutral  btn-icon btn-round" title="facebook">
                                <img src="../assets/img/facebook-icon-1.png" style="width:40px; height:40px;" alt="facebook">
                            </a>
                            <a href="{{$users->details[0]->Twitter}}" target="_blank" class="btn btn-neutral  btn-icon btn-round" title="twitter">
                                <img src="../assets/img/twitter-icon-2.png" style="width:40px; height:40px;" alt="twitter">
                            </a>
                            <a href="{{$users->details[0]->Youtube}}" target="_blank" class="btn btn-neutral  btn-icon btn-round" title="youtube">
                                <img src="../assets/img/youtube-icon-2.png" style="width:40px; height:40px;" alt="youtube">
                            </a>
                            <a href="{{$users->details[0]->Siteweb}}" target="_blank" class="btn btn-neutral  btn-icon btn-round" title="siteweb">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 mt-2">
                <div class="">
                    ...
                    <form action="/student-update-semester/{{$users->id}}" method="POST" class="position-relative" style="margin-bottom:; margin-top:; top:8px; left:-8px;">
                        {{ csrf_field() }}
                        {{method_field('PUT')}}
                        <div class="form-group m-0  row {{-- justify-content-center --}} position-absolute">
                                                ...
                                                <div class="card-block p-0" style="margin:-3px;">
                                                    ...
                                                    <div class="card-body  p-0 " >
                                                        ...
                                                        <div id="comments{{$m.'D'}}" class="collapse in p-1">
                                                                        ...
                                                                        <div class="card  p-0 m-0">
                                                                            <div class="card-block  m-0 p-0 pt-1 bgblack position-relative">
                                                                                @if ($com->user->id==Auth::user()->id)
                                                                                    {{-- delete comment --}}
                                                                                    <form action="/Delete-Comment-student/{{$com->user_id}}" method="POST" class="">
                                                                                        {{ csrf_field() }}
                                                                                        {{ method_field('DELETE')}}
                                                                                        <div class="" hidden>
                                                            ...
                                                            @endforeach
                                                            {{-- add comments --}}
                                                            <form action="/addCommentstudent/{{Auth::user()->id}}" method="post" class="mt-1">
                                                                {{ csrf_field() }}
                                                                <div class="" hidden>
