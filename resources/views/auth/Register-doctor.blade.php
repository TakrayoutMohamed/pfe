            ...
            <div class="card-body bgwhite m-0 p-1 justify-content-center row m-0" style="background: url('../assets/img/appointment.jpg') center center; background-size:100% 100%; min-height:356px;">
                <div class="card col-lg-6 col-md-8 col-sm-10 col-12 mt-4" style="background-color:black; color:white;">
                    <div class="card-header row mx-0 p-4  justify-content-center">
                        <p class="m-0 p-0 h5" style="color: gray;"> Register Professor </p>
                    </div>
                    <div class="card-body " >
                        <form method="POST" action="{{ route('register-doctor') }}">
                            ...
                            <div class="form-group row">
                                <label for="FirstName" class="col-md-4 col-form-label text-md-left mx-0">{{ __('First Name') }}</label>
                            ...
                            {{-- LastName --}}
                            <div class="form-group row">
                                <label for="LastName" class="col-md-4 col-form-label text-md-left mx-0">{{ __('Last Name') }}</label>
                            ...
                            {{-- E-Mail --}}
                            <div class="form-group row">
                                <label for="email" class="col-md-4 col-form-label text-md-left mx-0">{{ __('E-Mail Address') }}</label>
                            ...
                            {{-- Number --}}
                            <div class="form-group row">
                                <label for="Number" class="col-md-4 col-form-label text-md-left mx-0">{{ __('Phone Number') }}</label>
                            ...
                            {{-- Feliere --}}
                            <div class="form-group row">
                                <label for="Feliere" class="col-md-4 col-form-label text-md-left mx-0">{{ __('Field') }}</label>
                                <div class="col-md-8 mx-0">
                            ...
                            {{-- Gender --}}
                            <div class="form-group row">
                                <label for="Gender" class="col-md-4 col-form-label text-md-left mx-0">{{ __('Gender') }}</label>
                            ...
                            {{-- password --}}
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-left mx-0">{{ __('Password') }}</label>
                            ...
                            {{-- confirm password --}}
                            <div class="form-group row" >
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-left mx-0">{{ __('Confirm Password') }}</label>
