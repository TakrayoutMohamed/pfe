...
<body class="user-profile">
  <div class=" p-0 m-0">
    @if (session('status'))
      <div class="alert alert-success p-0 m-0 text-center" role="alert" style="color:red; font-size:20px;">
        {{ session('status') }}
      </div>
    @endif
  </div>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <div class="">
              {{-- <button type="button" class="navbar-toggler " data-toggle="collapse" data-target="#drop">
              ...
              <div class="collapse navbar-collapse justify-content-end" id="nav">
                <ul class="row navbar-bar">
                  ...
                  <div >
                    <a class="navbar-brand radiusDD" href="/">Main page</a>
                  </div>
                  <div >
                  <a class="navbar-brand" href="/student-data-edit/{{Auth::user()->id}}">EDIT Information</a>
                  </div>
                </ul>
              </div>
            </div>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby='navbarDropdownMenuLink'>
                    ...
                    <a class="dropdown-item" href="/student-data-edit/{{Auth::user()->id}}">Edit information</a>
